                    ...
                    <tr>
                      <td style="padding:36px 40px 40px;">
                        ...
                        <p style="margin:0 0 28px;font-size:15px;line-height:1.6;color:#cbd2dc;">
                          To finish setting up your Fight Calendar account, confirm this email address. You'll be signed in automatically.
                        </p>
                          ...
                          <tr>
                            <td style="padding-top:24px;">
                              ...
                              <p style="margin:0;font-size:13px;line-height:1.6;color:#9aa0aa;">
                                Someone used this address to create a Fight Calendar account. If that wasn't you, you can ignore this email - the account can't be used until it's confirmed, and this link expires.
                              </p>
                            </td>
                          </tr>
                        </table>
